...
function ProfilePageContent() {
	...
	return (
		<div className="mx-auto flex w-full max-w-6xl flex-col gap-6 px-4 pb-8 md:px-6">
			...
			<div className="w-full overflow-hidden rounded-2xl border border-surface-border bg-surface shadow-card dark:border-slate-700 dark:bg-slate-900/60">
				<Tabs defaultValue="about">
					<TabsList className="flex h-auto min-h-10 w-full flex-wrap justify-start gap-1 border-b border-surface-border bg-slate-50 p-2 dark:border-slate-700 dark:bg-slate-800/50">
