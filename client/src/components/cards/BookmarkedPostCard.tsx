...
export default function BookmarkedPostCard() {
	...
	return (
		<div>
			<h1 className="mb-2 text-center font-display text-2xl font-bold text-ink dark:text-slate-100 sm:text-3xl">
				Saved posts
			</h1>
			<p className="mb-6 text-center text-sm text-ink-muted dark:text-slate-500">
				{bookmarks?.results.length ?? 0} saved from the building board
			</p>
