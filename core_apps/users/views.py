...
class CustomTokenObtainPairView(TokenObtainPairView):
    """
    Custom TokenObtainPairView that sets the access and refresh tokens as cookies.
    """
    ...
    def post(self, request: Request, *args, **kwargs) -> Response:
        ...
        if token_res.status_code == status.HTTP_200_OK:
            ...
            if access_token and refresh_token:
                ...
                logger.error("Failed to obtain access or refresh tokens")
...
class CustomTokenRefreshView(TokenRefreshView):
    """
    Custom TokenRefreshView that sets the access token as a cookie.
    """
